  ...
  return (
    <div className="fixed inset-0 bg-slate-950 z-50 flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-slate-800 p-8 rounded-xl shadow-2xl max-w-md w-full">
        ...
        {errorMsg && (
          <div className="mb-4 bg-red-950/70 border border-red-800 text-red-300 text-xs p-3 rounded flex items-center gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-sm">
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-slate-800 border border-slate-700 rounded p-2.5 text-white focus:outline-none focus:border-indigo-500 placeholder:text-slate-500"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full bg-slate-800 border border-slate-700 rounded p-2.5 pr-10 text-white focus:outline-none focus:border-indigo-500 placeholder:text-slate-500"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-2.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-white transition-colors focus:outline-none"
