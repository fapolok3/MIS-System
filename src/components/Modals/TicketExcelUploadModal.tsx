...
export const TicketExcelUploadModal: React.FC<TicketExcelUploadModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/75 flex items-center justify-center p-4 z-50 animate-fadeIn">
      <div className="bg-slate-900 border border-slate-700 rounded-xl max-w-4xl w-full p-6 space-y-4 shadow-2xl max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="flex justify-between items-center border-b border-slate-800 pb-3">
          <div className="flex items-center gap-2.5">
            <div className="p-2 bg-indigo-950/80 text-indigo-400 border border-indigo-800/80 rounded-lg">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Bulk import ticket records into <span className="text-indigo-400 font-semibold">Service Ticket & SLA Tracker</span>
              </p>
            </div>
          </div>
          <button
        ...
        <div className="space-y-4 overflow-y-auto flex-1 pr-1">
          ...
          <div
            ...
            className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition flex flex-col items-center justify-center gap-2 ${
              dragActive
                ? 'border-indigo-400 bg-indigo-950/20 text-indigo-300'
                : file
          ...
          >
            ...
            {file ? (
              <div>
                <p className="text-xs font-bold text-indigo-400 flex items-center justify-center gap-1">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400 mt-0.5 max-w-xl mx-auto">
                ...
                <table className="w-full text-left text-[11px] border-collapse min-w-[1200px]">
                  <thead className="bg-slate-950 text-slate-400 font-bold uppercase sticky top-0 border-b border-slate-800">
                    <tr>
                      ...
                      <th className="p-2 border-r border-slate-800">Issue Number</th>
                      ...
                      <th className="p-2 border-r border-slate-800">Issue Type</th>
                      <th className="p-2 border-r border-slate-800">Priority</th>
                      <th className="p-2 border-r border-slate-800">Status</th>
                      <th className="p-2 border-r border-slate-800">Technician</th>
                      <th className="p-2 border-r border-slate-800">SLA Status</th>
                  ...
                  <tbody className="divide-y divide-slate-800 text-slate-300 font-mono">
                    {parsedData.map((row, idx) => (
                      <tr key={idx} className="hover:bg-slate-800/50">
                        ...
                        <td className="p-2 border-r border-slate-800 max-w-[200px] truncate text-slate-200">{row.subject}</td>
                        <td className="p-2 border-r border-slate-800">{row.location}</td>
                        <td className="p-2 border-r border-slate-800 text-emerald-400 font-bold">{row.deviceId}</td>
                        <td className="p-2 border-r border-slate-800">{row.issueType}</td>
                        ...
                        <td className="p-2 border-r border-slate-800">{row.tech}</td>
                        <td className="p-2 border-r border-slate-800">
                          <span className={`px-1.5 py-0.5 rounded text-[10px] font-bold ${
