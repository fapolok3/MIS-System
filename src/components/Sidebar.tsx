        ...
        <div className="p-4 space-y-6">
          ...
          <div>
            ...
            <nav className="space-y-1 text-xs">
              ...
              >
                <AlertCircle className="w-4 h-4 text-indigo-600 dark:text-indigo-400" /> Issue Tracker
              </button>
              <button
                onClick={() => setActiveTab('issue_report')}
                className={`w-full text-left px-3 py-2 rounded flex items-center gap-2 transition cursor-pointer ${
              ...
              >
                <FileBarChart2 className="w-4 h-4 text-indigo-600 dark:text-indigo-400" /> Issue Report
              </button>
              <button
                onClick={() => setActiveTab('po')}
                className={`w-full text-left px-3 py-2 rounded flex items-center gap-2 transition cursor-pointer ${
